...
3. Start the server and mention **@Campfire AI** inside any room. The assistant receives the full conversation context and replies via the CloudRift DeepSeek model.
